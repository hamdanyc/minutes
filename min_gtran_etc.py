...
# input_files = sorted(os.listdir("res"), key=keyfunc)
input_files = sorted(os.listdir("res"))
...
for input_file in input_files:
    ...
    with open(f"res/{input_file}", "r") as file:
        ...
        output_file_path = "out/trans.txt"
        with open(output_file_path, "a", encoding="utf-8") as file:
            file.write(f"res/{input_file}" +"\n\n" + translated_text.text + "\n\n")
